...
function upload(sets) {
  ...
  fs.readFile(opts.sourceBundle, function(err, data) {
    ...
    putObjectParam.Bucket = bucketParam.Bucket;
    putObjectParam.Key = bucketParam.Key;
    putObjectParam.Body = new Buffer(data);
    
    if (opts.serverSideEncryption) {
      putObjectParam.ServerSideEncryption = opts.serverSideEncryption
    }

    s3.putObject(putObjectParam, function(err, result){
